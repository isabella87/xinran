...
<div class="ban_path">
  <div class="ban_wrapper">
     <div class="ban_path_in"><a href="/xinran/index.html" class="ban_path_home"></a>&gt;<a href="javascript:;" id="_cursor" class="ban_path_a"></a></div>
    <%-- <div class="ban_path_in"><a href="/xinran/index.html" class="ban_path_home"></a>&gt;<a href="#" class="ban_path_a">资讯</a></div>
 --%>  
 </div>
</div>
...
var page = { curr: Sys.getPage() || 1, type : type||1 , isMainPage : true};
...
function onInfoDetailView(type,id,hash){
	    window.location.assign(Sys.evalUrl('/maintain/info-detail.html?type=' + type +'&id=' + id + '&hash=' + hash));
}
